...
def get_params():
    params = {
        'weight': 'runs/train/yolov5s-Bifpn-mobileNet-ECA-spd/Accident/exp3/weights/best.pt',
        #runs/train/yolov5s-ECA/Accident/exp/weights/best.pt  runs/train/yolov5/Accident/exp/weights/best.pt
        'cfg': 'models/yolov5s-Bifpn-mobileNet-ECA-spd.yaml',#   models/yolov5s-ECA.yaml
        #models/yolov5s.yaml
        'device': 'cuda:0',
        'method': 'GradCAM', # GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM, RandomCAM, EigenGradCAM
        'layer': 'model.model[-11]',
        'backward_type': 'conf', # class, box, all
...
if __name__ == '__main__':
    ...
    model(r'AAhotpic/test25_26.jpg', 'result/all_AAhotpic/test25_26/-11')#AAhotpic/test25_26.jpg
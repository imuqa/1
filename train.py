...
from utils.loggers.comet.comet_utils import check_comet_resume, logger
...
def parse_opt(known=False):
    ...
    parser.add_argument('--hyp', type=str, default=ROOT / 'data/hyps/hpy.BDD100k.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--resume', nargs='?', const=True, default=False, help='resume most recent training')#default=True
